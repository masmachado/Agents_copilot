...
Getting started
Using this template repository, create a private repository called .github-private in your organization.
Edit this README to best meet your needs. Consider including creation guidelines for custom agents or compliance considerations specific to your team.
Edit the provided agents/example-agent.md file to create your first custom agent. For more information, see Creating custom agents.